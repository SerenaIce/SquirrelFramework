...
dotnet pack --configuration release -p:NuspecFile=SquirrelFramework.Domain.Model.nuspec
rem or execute
rem msbuild /t:pack /p:Configuration=Release /p:NuspecFile=SquirrelFramework.Utility.nuspec

rem To change the version
nuget push SquirrelFramework.Domain.Model.1.0.0.nupkg -Source https://www.nuget.org/api/v2/package